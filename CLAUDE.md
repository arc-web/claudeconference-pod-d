...
- Danilo Jr. B. Casim (Pod Leader) - Has a Claude subscription, on Mac
- Vilmore Villadolid - Has a Claude subscription, on Windows
- Rumejan Barbarona - Has used AI coding tools before, on Mac
- Gabriel Martinez Portillo - Has used AI coding tools before, on Windows
- Carl - New to AI tools, on unknown

Pod Leader: Danilo Jr. B. Casim - keeps the team moving, calls votes when stuck, makes sure everyone has something to do.
